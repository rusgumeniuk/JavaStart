...
public class MainIO {
     static char getCryptedChar(Character symbol, Character key){
     ...
     static char getDecryptedChar(Character symbol, Character key){
     ...
     static String getCryptedString(String text, Character keyCharacter){
     ...
     static String getDecryptedString(String text, Character keyCharacter){
        if(keyCharacter == null || keyCharacter.toString().isEmpty() || text.isEmpty()) throw new IllegalArgumentException();
     ...
     static String getDecryptedTextFromFile(String path, Character key) throws IOException {
        StringBuilder decryptedText = new StringBuilder();
     ...
     static void writeCryptTextToFile(String path, String text, Character key) throws IOException {
